    ...
    public partial class Modelscreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CocktailInOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CocktailInOrders_Cocktails_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Cocktails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CocktailInOrders_Orders_CocktailId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CocktailInShoppingCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CocktailInShoppingCarts_Cocktails_ShoppingCartId",
                        column: x => x.ShoppingCartId,
                        principalTable: "Cocktails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CocktailInShoppingCarts_ShoppingCarts_CocktailId",
                        column: x => x.CocktailId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ingredients_Cocktails", x => new { x.IngredientId, x.CocktailId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CocktailInOrders_CocktailId",
                table: "CocktailInOrders",
                column: "CocktailId");

            migrationBuilder.CreateIndex(
                name: "IX_CocktailInOrders_OrderId",
                table: "CocktailInOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CocktailInShoppingCarts_CocktailId",
                table: "CocktailInShoppingCarts",
                column: "CocktailId");

            migrationBuilder.CreateIndex(
                name: "IX_CocktailInShoppingCarts_ShoppingCartId",
                table: "CocktailInShoppingCarts",
